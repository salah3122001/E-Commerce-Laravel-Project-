        ...
        <div class="card auth-card">
            ...
            <div class="card-body p-4">
                <form method="POST" action="{{ route('register') }}">
                    ...
                    {{-- Confirm Password --}}
                    <div class="mb-3">
                        <label for="password-confirm" class="form-label">{{ __('messages.cpass') }}</label>
                ...
                @if (Route::has('login'))
                    <div class="login-link">
                        <p>{{ __('messages.no_account') ?? 'Already have an account?' }}
                            <a href="{{ route('login') }}">{{ __('messages.login') ?? 'Login' }}</a>
                        </p>
                    </div>
                @endif
            </div>
